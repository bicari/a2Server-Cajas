...
async def search_database_files()  -> bool :
        try:
            LIST_TABLES = ['Sinventario', 'SSistema',  'SFixed', 'SCodebar', 'a2InvCostosPrecios', 'Soferta', 'Susuarios', 'Sclientes', 
                       'SInvOferta', 'Smoneda', 'SUsersFlag', 'SCierresCaja', 'SclientesEventuales', 'SDetalleVenta', 'SFormasPago'] #Lista de tablas a sincronizar al iniciar app
